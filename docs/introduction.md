    ...
    <div className="w-50 mh4 dim">
        <a href="https://github.com/vtex/styleguide/issues" className="link c-on-base">
            <Card>
                ...
                <p className="">
                    Github is our place for tracking new components requests, ideas, tasks and bug reports. Feel free to document here you ideas, or pick any issue to contribute on!
                </p>
            </Card>
        </a>
    </div>
    ...
    <div className="w-50 mh4 dim">
        <a href="https://vtex.slack.com/app_redirect?channel=styleguide-onda" className="link c-on-base">
            <Card>
                ...
                <p className="">
                    If you're inside VTEX, come join us at the <b>#styleguide-onda</b> Slack channel and our weekly meetings.
                </p>
            </Card>
        </a>
    </div>
