...
<div className="flex flex-row-ns flex-column tc mv7">
  ...
  <div className="w-third-ns w-100 ma4 dim">
    <a
      ...
      className="link c-on-base">
      <Card>
        <div className="w-third center">	
          <img src="https://cdn.freebiesupply.com/logos/large/2x/figma-1-logo-png-transparent.png"/>
        </div>
        <p className="f6">
