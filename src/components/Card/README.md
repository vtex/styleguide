...
<div style={{padding: '80px', color: '#585959', background: '#fafafa'}}>
  <Card fullWidth={true}>
    <h3 className="pl6 pr6">Spider</h3>
    <img
    width="100%"
    ...
    <p className="pl6 pr6">It is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
  </Card>
</div>
```
