...
const Failure = ({ fill, width, height }) => (
  <svg
    viewBox="0 0 14 14"
  ...
  >
    <g fill={fill}>
      <path d="M8.838 3.938L7 5.774 5.162 3.937 3.938 5.162 5.774 7 3.937 8.838l1.225 1.225L7 8.224l1.838 1.838 1.225-1.226L8.224 7l1.838-1.838z" />
